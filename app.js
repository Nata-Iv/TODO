...
form.addEventListener('submit', onFormSubmitHundler);
...
function renderOfTasks(tasksList) {
  if (!tasksList) {
    console.log("Pass on the tasks' list");
    return;
  }
...
function onFormSubmitHundler(e) {
  ...
  if (!titleValue || ! bodyValue) {
    alert("Please enter your title and body");
    return;
  }
...
function deleteTask(id) {
  ...
  const isConfirm = confirm(`Confirm delete this ${title}`);
...
function onThemeSelectHandler(e) {
  ...
  const isConfirmed = confirm(`Do you want to set the theme: ${selectTheme}`);
  if (!isConfirmed) {
